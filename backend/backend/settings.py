...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv("DB_NAME", "jobportal"),  # Database Name
        'USER': os.getenv("DB_USER", "jobuser"),  # Database User
        # Database Password
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  # Where static files are located
MEDIA_URL = '/media/'
